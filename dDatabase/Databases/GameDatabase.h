...
public:
	...
	virtual void InsertCheatDetection(std::optional<uint32_t> userId, const std::string_view username, const std::string_view systemAddress, const std::string_view extraMessage) = 0;
